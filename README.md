if game.PlaceId == 6707053754 then

do 
    local ui =  game:GetService("CoreGui"):FindFirstChild("Smile-Lib") 
    if ui then
        ui:Destroy()
    end
end
...
return library, library_flags, library.subs
    ...
    game.Players.LocalPlayer:Kick("มึงเข้าผิดเกมแล้วไอโง้")
   wait(5)
    game:Shutdown()
end
