...
local dataencode =
    bestrequest(
    {
        ["Url"] = "http://localhost/server.php?key=" .. _G.Keys .. "&time=" .. timer,
        ["Method"] = "GET"
    }
)
local hwidencode =
    bestrequest(
    {
        ["Url"] = "http://localhost/gethwid.php",
        ["Method"] = "GET"
    }
)

local time_url = "http://localhost/ostime.php?time=" .. timer .. "&UwU=" .. randomString
...
local osc = {
    ...
    [8] = _G.Keys .. HWID .. t2["8"],
    [9] = _G.Keys .. HWID .. t2["9"],
    [10] = _G.Keys .. HWID .. t2["10"],
    [11] = _G.Keys .. HWID .. t2["11"],
    [12] = _G.Keys .. HWID .. t2["12"],
    [13] = _G.Keys .. HWID .. t2["13"],
    [14] = _G.Keys .. HWID .. t2["14"],
    [15] = _G.Keys .. HWID .. t2["15"],
    [16] = _G.Keys .. HWID .. t2["16"],
    [17] = _G.Keys .. HWID .. t2["17"],
    [18] = _G.Keys .. HWID .. t2["18"],
    [19] = _G.Keys .. HWID .. t2["19"],
    [20] = _G.Keys .. HWID .. t2["20"],
    [21] = _G.Keys .. HWID .. t2["21"],
    [22] = _G.Keys .. HWID .. t2["22"],
    [23] = _G.Keys .. HWID .. t2["23"]
}
    ...
    if data ~= "" then
        if data ~= "Update Hwid" then
            ...
            local hwidencode =
                bestrequest(
                {
                    ["Url"] = "http://localhost/changehwid.php?key=" .. _G.Keys .. "&hwid=" .. HWID,
                    ["Method"] = "GET"
                }
            )   
        end
